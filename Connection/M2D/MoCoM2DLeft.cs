...
{
    public class MoCoM2DLeft : MoCoM2D
    {
        public const int classIdentifier = 0;

        #region Create MoCoM2D class

        public static MoCoM2D CreateMoCoM2DClassLeft(DaConnection daConnection, M2DType m2dType, MoProfile prDown, MoProfile prUp)
        {
            if (m2dType == M2DType.Left)
            {
                ...
                return new MoCoM2DLeft(daConnection, prDown, prUp);
            }

            return null;
        }

        public static MoCoM2D CreateMoCoM2DClassFromIdentifierLeft(DaConnection daConnection, int classidentifier, List<MoProfile> profileInput)
        {
        ...
        public MoCoM2DLeft(DaConnection daConnection, MoProfile prdown, MoProfile prup) : base(daConnection, prdown, prup)
        {
        }
